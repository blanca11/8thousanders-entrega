...
<ul class="mb-4">
  @foreach($disco->comentarios as $c)
    <li>
...
@php
  $yaComentó = $disco->comentarios->contains('id_usuario', auth()->id());
@endphp

@if($disco->comentarios->count() < 3 && ! $yaComentó)
  <div class="bg-gray-50 p-4 rounded">
    <h4 class="font-medium mb-2">Añadir mi comentario</h4>
    <form action="{{ route('admin.disco.comentarios.store', $disco) }}" method="POST" class="space-y-3">
      @csrf
      <div>
