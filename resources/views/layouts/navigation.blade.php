    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.admin.register')" :active="request()->routeIs('dashboard')">
                        {{ __('Nuevo Admin') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('admin.artistas.index')" :active="request()->routeIs('dashboard')">
                        {{ __('Artistas') }}
                    </x-nav-link>
                </div>
            </div>
